...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function PumaKazakhstanCasePage() {
        ...
        <HeroWave />
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/puma.webp')" }}
                    />
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="grid grid-cols-3 gap-px border border-white/10">
                                    {[
                                        ...
                                        { label: "Направление", value: "Ритейл" },
                                    ].map(({ label, value }) => (
                                        <div
                                            key={label}
                                ...
                                <Button01
                  href="https://www.instagram.com/puma_fam_kz/"
                  target="_blank"
                  rel="noopener noreferrer"
