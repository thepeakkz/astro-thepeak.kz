...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function LukoilCasePage() {
    ...
    return (
        ...
        <HeroWave />
          ...
          <video
            src={preloadedCache["/cases/lukoil.mp4"] || "/cases/lukoil.mp4"}
            autoPlay
            loop
            muted
            playsInline
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="grid grid-cols-3 gap-px border border-white/10">
                                    {[
                                        ...
                                        { label: "Направление", value: "Производство" },
                                    ].map(({ label, value }) => (
                                        <div
                                            key={label}
                                ...
                                <Button01
                  href="https://www.instagram.com/lukoil.lubricants.kz/"
                  target="_blank"
                  rel="noopener noreferrer"
