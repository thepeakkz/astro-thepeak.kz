...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function BlinkMapCasePage() {
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/blink.webp')" }}
          />
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="grid grid-cols-3 gap-px border border-white/10">
                  {[
                    ...
                    { label: "Направление", value: "IT-бизнес" },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="w-full space-y-8">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      rows={3}
                      placeholder="Расскажите о задачахและ цели проекта..."
