...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function OnmacabimCasePage() {
        ...
        <HeroWave />
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/onmacabim.webp')" }}
                    />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-8 gap-y-8 items-end">
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="grid grid-cols-3 gap-px border border-white/10">
                                    {[
                                        { label: "Старт", value: "2024" },
                                        { label: "Услуга", value: "SMM" },
                                        { label: "Направление", value: "Косметика" },
                                    ].map(({ label, value }) => (
                                        <div
                                            key={label}
                                ...
                                <Button01
                  href="https://www.instagram.com/onmacabim_cosmetic.kz"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* ── REELS GRID GALLERY ────────────────────────────── */}
                <CaseVideoGallery slug="onmacabim" />
