...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function BazisCasePage() {
    ...
    <>
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <video
            src={preloadedCache["/cases/bazis a.mp4"] || "/cases/bazis a.mp4"}
            autoPlay
            loop
            muted
            playsInline
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="grid grid-cols-3 gap-px border border-white/10">
                  {[
                    ...
                    { label: "Направление", value: "Девелопмент" },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
                ...
                <Button01
                  href="https://www.instagram.com/bazis.kz/"
                  target="_blank"
                  rel="noopener noreferrer"
