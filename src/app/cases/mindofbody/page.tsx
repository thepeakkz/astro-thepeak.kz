...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function MindOfBodyCasePage() {
        ...
        <HeroWave />
                ...
                <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
                    <div
                        ...
                        style={{ backgroundImage: "url('/cases/mob.webp')" }}
                    />
                            ...
                            <div className="lg:col-span-4 space-y-8">
                                <div className="grid grid-cols-3 gap-px border border-white/10">
                                    {[
                                        ...
                                        { label: "Направление", value: "Фитнес" },
                                    ].map(({ label, value }) => (
                                        <div
                                            key={label}
                                ...
                                <Button01
                  href="https://www.instagram.com/mindofbody.almaty/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* ── REELS GRID GALLERY ────────────────────────────── */}
                <CaseVideoGallery slug="mindofbody" />
