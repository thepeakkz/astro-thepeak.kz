...
// ─── Main Page Component ───────────────────────────────────────────────────────
export default function CadillacCasePage() {
      ...
      >
        ...
        <section className="relative min-h-screen flex flex-col justify-end overflow-hidden border-b border-white/10">
          <div
            ...
            style={{ backgroundImage: "url('/cases/cadillac.webp')" }}
          />
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="grid grid-cols-3 gap-px border border-white/10">
                  {[
                    ...
                    { label: "Направление", value: "Продажа Авто" },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
                ...
                <Button01
                  href="https://www.instagram.com/cadillac.qazaqstan/"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {metrics.map(({ value, label, index }) => (
              ...
              >
                ...
                {/* ── REELS GRID GALLERY ────────────────────────────── */}
                <CaseVideoGallery slug="cadillac" />
