  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ x: marqueeX }}
      >
        {[60, 3, 5, 6, 13, 17, 18, 23, 24, 32, 42, 44, 52, 60, 3, 5, 6, 13, 17, 18, 23, 24, 32, 42, 44, 52, 60, 3, 5, 6, 13, 17, 18, 23, 24, 32, 42, 44, 52, 60, 3, 5, 6, 13, 17, 18, 23, 24, 32, 42, 44, 52].map((id, index) => (
          <div
            key={index}
