    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Главная страница (поп-ап через 40 секунд)",
        }),
      });
      ...
      console.error("Failed to submit timed popup form:", error);
      setStatus("error");
    }
  };
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="timed-lead-popup-title"
        tabIndex={-1}
      ...
      >
        ...
        <div className="max-h-[calc(100dvh-2rem)] overflow-y-auto p-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:p-10">
          {status === "success" ? (
            ...
            <h2 id="timed-lead-popup-title" className="font-headline text-xl font-semibold text-white">
            ...
            <div className="pr-10">
              ...
              <h2 id="timed-lead-popup-title" className="mt-2 font-headline text-2xl font-bold leading-tight tracking-wide text-white md:text-3xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label htmlFor="timed-lead-name" className="block font-sans text-[10px] font-extrabold uppercase tracking-widest text-neutral-400">
                  Ваше имя
                </label>
                <input
                  id="timed-lead-name"
